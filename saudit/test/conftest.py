...
from saudit.core.helpers.misc import execute_sync_or_async
from saudit.core.helpers.interactsh import server_list as interactsh_servers
...
def pytest_sessionfinish(session, exitstatus):
    ...
    loggers = [logging.getLogger("saudit")] + list(logging.Logger.manager.loggerDict.values())
