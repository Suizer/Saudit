...
async def test_helpers_misc(helpers, scan, saudit_scanner, saudit_httpserver):
    ...
    from saudit.core.helpers.regexes import url_regexes
...
async def test_word_cloud(helpers, saudit_scanner):
    ...
    # mutators
    from saudit.core.helpers.wordcloud import DNSMutator
...
async def test_ratelimiter(helpers):
    from saudit.core.helpers.ratelimiter import RateLimiter
...
async def test_async_helpers():
    import random
    from saudit.core.helpers.misc import as_completed
