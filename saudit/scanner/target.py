...
from saudit.core.event import is_event
from saudit.core.event.helpers import EventSeed, BaseEventSeed
from saudit.core.helpers.misc import is_dns_name, is_ip, is_ip_type

log = logging.getLogger("saudit.core.target")
