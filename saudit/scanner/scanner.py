...
from saudit import __version__
from saudit.core.event import make_event, update_event
from .manager import ScanIngress, ScanEgress
from saudit.core.helpers.misc import sha1, rand_string
from saudit.core.helpers.names_generator import random_name
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if self.preset.scan_name is None:
            ...
            while 1:
                ...
                if self.preset.output_dir is not None:
                    ...
                    home_path = self.preset.saudit_home / "scans" / scan_name
        ...
        if self.preset.output_dir is not None:
            ...
            self.home = self.preset.saudit_home / "scans" / self.name
