...
from saudit.scanner.target import BaseTarget

log = logging.getLogger("saudit.core.helpers")
...
class ConfigAwareHelper:
    ...
    def __init__(self, preset):
        self.preset = preset
        self.saudit_home = self.preset.saudit_home
        self.cache_dir = self.saudit_home / "cache"
        self.temp_dir = self.saudit_home / "temp"
        self.tools_dir = self.saudit_home / "tools"
        self.lib_dir = self.saudit_home / "lib"
        self.scans_dir = self.saudit_home / "scans"
