...
from saudit.core.engine import EngineClient
from saudit.core.helpers.misc import truncate_filename
from saudit.errors import WordlistError, CurlError, WebError
...
log = logging.getLogger("saudit.core.helpers.web")
...
class WebHelper(EngineClient):
    ...
    def response_to_json(self, response):
        ...
        from saudit.core.helpers.misc import tagify, urlparse, split_host_port, smart_decode
