...
from saudit.core.helpers import (
    extract_words,
    is_domain,
    is_subdomain,
    is_ip,
...
from saudit.core.helpers.web.envelopes import BaseEnvelope


log = logging.getLogger("saudit.core.event")
...
class FILESYSTEM(DictPathEvent):
    def __init__(self, *args, **kwargs):
        ...
        if self._data_path.is_file():
            ...
            from saudit.core.helpers.libmagic import get_magic_info, get_compression
