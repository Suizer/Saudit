...
from saudit.core.helpers.misc import chain_lists, rm_rf
...
if multiprocessing.current_process().name == "MainProcess":
    ...
    if not silent:
        ascii_art = (
            ...
            " \033[1;31m███████║██║  ██║╚██████╔╝██████╗██║   ██║   \033[0m\n"
            " \033[1;31m╚══════╝╚═╝  ╚═╝ ╚═════╝ ╚═════╝╚═╝   ╚═╝   \033[0m\n"
            f" \033[2m SuizerAudit \u2014 Autonomous Web Recon  {__version__}\033[0m\n"
        )
...
async def _main():
    ...
    log = logging.getLogger("saudit.cli")
    ...
    try:
        ...
        preset = Preset(_log=True, name="saudit_cli_main")
        ...
        if not options.dry_run:
            ...
            if sys.stdin.isatty():
                ...
                import re
                import fcntl
                from saudit.core.helpers.misc import smart_decode
