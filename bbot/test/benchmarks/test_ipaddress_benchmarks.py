...
class TestIPAddressBenchmarks:
    ...
    def _generate_valid_ips(self):
        ...
        # IPv4 addresses
        for i in range(1000):
            valid_ips.append(f"{random.randint(1, 223)}.{random.randint(0, 255)}.{random.randint(0, 255)}.{random.randint(1, 254)}")
        ...
        # IP ranges
        for i in range(200):
            start_ip = f"{random.randint(1, 223)}.{random.randint(0, 255)}.{random.randint(0, 255)}.{random.randint(1, 200)}"
    ...
    def _generate_invalid_ips(self):
        ...
        # Malformed IPv4
        for i in range(500):
            invalid_ips.append(f"{random.randint(256, 999)}.{random.randint(0, 255)}.{random.randint(0, 255)}.{random.randint(0, 255)}")
            invalid_ips.append(f"{random.randint(0, 255)}.{random.randint(0, 255)}.{random.randint(0, 255)}")
            invalid_ips.append(f"{random.randint(0, 255)}.{random.randint(0, 255)}.{random.randint(0, 255)}.{random.randint(0, 255)}.{random.randint(0, 255)}")
